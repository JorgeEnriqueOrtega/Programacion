...
class MenuEjecutivo:
    ...
    def menu(self):
        ...
        while True:
            ...
            if opcion == 1:
                ...
                print("\n")
                df_ejecutivo_global = self.registrar_ejecutivo_nuevo(df_ejecutivo_global)
            elif opcion == 5:
                print("\n")
    ...
    def registrar_cliente_nuevo(self, df_cliente):
        ...
        saldo = 0
        apartado = 0
        cliente_nuevo = Cliente(nombre,apellido,fecha,correo,telefono,contrasenia,numero_cuenta,saldo,apartado)
    ...
    def registrar_ejecutivo_nuevo(cls, df_ejecutivo):
        ...
        ejecutivo_nuevo = Ejecutivo(nombre,apellido,fecha,correo,telefono,contrasenia,numero_cuenta,puesto,sucursal)
    ...
    def modificar_datos_cliente(self, df_cliente):
        ...
        if cuenta in diccionario_clientes.keys():
            ...
            if opcion == '1':
                ...
                nuevo_valor = input("Ingrese la nueva fecha de nacimiento (AAAA-MM-DD): ")
    ...
    def consultar_saldo_cliente(self):
        ...
        if cuenta in diccionario_clientes.keys():
            cliente = diccionario_clientes[cuenta]
            print(f"Cliente {cliente.nombre} {cliente.apellido} con saldo: {cliente.saldo}\n")
        else:
            print(f"No se encontró ningún cliente con el número de cuenta {cuenta}.")
